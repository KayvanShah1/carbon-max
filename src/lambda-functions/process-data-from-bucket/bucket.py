...
def push_json_to_buffer_bucket(bucket: S3Bucket, json_obj: dict, rel_path: str):
    ...
    Args:
        bucket (S3Bucket): The S3 bucket object to upload the JSON file to.
        json_obj (dict): The JSON object to be uploaded.
        rel_path (str): The relative path of the file within the bucket.
    ...
    try:
        ...
        print(f'{e}\nError occurred while pushing file to bucket path "{rel_path}"')
